package prepareSelectedDownload;
 ...
 */
public class ManualCoverageInstrumentation {
        ...
        try (PrintWriter writer = new PrintWriter(new FileWriter(filename))) {
            ...
            for (int i = 1; i <= branches.size(); i++) {
                ...
                if (branch != null) {
                    ...
                    writer.printf("Branch %2d: %-10s %s (hit %d times)\n", 
                        branch.id, status, branch.description, branch.hitCount);
    ...
    public static void printReport() {
        ...
        for (int i = 1; i <= branches.size(); i++) {
            ...
            if (branch != null) {
                String status = branch.wasCovered() ? "[COVERED]" : "[NOT COVERED]";
                System.out.printf("Branch %2d: %-10s %s (hit %d times)\n", 
                    branch.id, status, branch.description, branch.hitCount);
                if (branch.wasCovered()) {
                    coveredBranches++;
                }
